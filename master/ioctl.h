...
#define EC_IOCTL_SC_FOE_REQUEST       EC_IOWR(0x65, ec_ioctl_foe_request_t)
#define EC_IOCTL_FOE_REQUEST_FILE     EC_IOWR(0x66, ec_ioctl_foe_request_t)
#define EC_IOCTL_FOE_REQUEST_TIMEOUT  EC_IOWR(0x67, ec_ioctl_foe_request_t)
#define EC_IOCTL_FOE_REQUEST_STATE    EC_IOWR(0x68, ec_ioctl_foe_request_t)
#define EC_IOCTL_FOE_REQUEST_READ     EC_IOWR(0x69, ec_ioctl_foe_request_t)
#define EC_IOCTL_FOE_REQUEST_WRITE    EC_IOWR(0x6a, ec_ioctl_foe_request_t)
#define EC_IOCTL_FOE_REQUEST_DATA     EC_IOWR(0x6b, ec_ioctl_foe_request_t)
#define EC_IOCTL_RT_SLAVE_REQUESTS     EC_IOW(0x6c, uint32_t)
#define EC_IOCTL_EXEC_SLAVE_REQUESTS    EC_IO(0x6d)
